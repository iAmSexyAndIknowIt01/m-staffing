  ...
  const plans = [
    {
      ...
      features: ["Идэвхтэй 3 ажлын байр зарлах", "Үндсэн анкет хүлээн авах", "Статистик хянах хянах хавтан", "Имэйл тусламж"],
    ...
    },
    {
      ...
      price: "150,000 ₮",
      period: "сарын",
      features: ["Идэвхтэй 10 ажлын байр зарлах", "Шүүлтүүртэй анкет удирдах", "Зарласан ажлын хандалт үзэх", "24/7 Чат тусламж"],
