...
export default function CompanyView({ userId }: CompanyViewProps) {
  // Жишээ дата: Идэвхтэй ажлын байрууд
  const activeJobs = [
    {
      id: "job-1",
  ...
  // Жишээ дата: Хамгийн сүүлд ирсэн анкетууд (UX-ийн маш чухал нэмэлт)
    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-gray-100 p-6 rounded-4xl shadow-sm flex items-center justify-between group hover:border-orange-100 hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-black text-gray-900 tracking-tight">4</h3>
        ...
        <div className="bg-white border border-gray-100 p-6 rounded-4xl shadow-sm flex items-center justify-between group hover:border-emerald-100 hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-black text-emerald-600 tracking-tight">128</h3>
            <span className="text-[11px] font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg">+14 шинэ анкет</span>
          </div>
        ...
        <div className="bg-white border border-gray-100 p-6 rounded-4xl shadow-sm flex items-center justify-between group hover:border-blue-100 hover:shadow-md transition-all">
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-black text-blue-600 tracking-tight">8</h3>
            <span className="text-[11px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-lg">Энэ долоо хоногт</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* ШИНЭЭР ИРСЭН АНКЕТУУД (ШИНЭ ХЭСЭГ) */}
          <div className="space-y-4">
            <div className="flex justify-between items-center px-1">
              <h2 className="text-xl font-black text-gray-900">Сүүлд ирсэн анкетууд</h2>
              <Link href="/company/applicants" className="text-xs font-bold text-gray-400 hover:text-indigo-600 transition">
                Бүгдийг харах
              </Link>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-gray-100 p-6 rounded-4xl shadow-sm space-y-5">
            ...
            {/* Зарлах ажлын лимит (UX Нэмэлт) */}
            <div className="space-y-2 bg-slate-50 p-4 rounded-2xl border border-slate-100">
              <div className="flex justify-between text-xs font-bold">
                <span className="text-gray-500">Ажлын байрны лимит</span>
                <span className="text-slate-700">4 / 10 зар</span>
              </div>
              <div className="w-full bg-gray-200 h-2 rounded-full overflow-hidden">
                <div className="bg-slate-800 h-full rounded-full transition-all duration-500" style={{ width: "40%" }} />
              </div>
            </div>
